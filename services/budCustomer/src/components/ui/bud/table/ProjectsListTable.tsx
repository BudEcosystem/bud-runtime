...
import { Credentials, useCredentials } from "@/stores/useCredentials";
      ...
      <Table<Credentials>
        ...
        columns={[
          ...
          },
          {
            ...
            sorter: (a, b) =>
              String(a.max_budget || "").localeCompare(
                String(b.max_budget || ""),
              ),
            sortIcon: SortIcon,
          },
          ...
          <div className="flex justify-between items-center px-[0.75rem] py-[1rem]">
            ...
            <div className="flex items-center justify-between">
              ...
              <Popover
                ...
                content={
                  <div className="bg-[#161616] shadow-none  border border-[#1F1F1F] rounded-[6px] width-296">
