...
} from "@/stores/useProprietaryCredentials";
      ...
      <Table<Credentials>
        ...
        columns={[
          ...
          },
          {
            ...
            key: "provider_icon",
            width: 150,
            render: (_, record: Credentials) => (
              <div className="select-none flex items-center">
                <div className="w-[0.875rem] h-[0.875rem]">
                  <Image
                    src={`${assetBaseUrl}${record.provider_icon}`}
                    preview={false}
          ...
          <div className="flex justify-between items-center px-[0.75rem] py-[1rem]">
            ...
            <div className="flex items-center justify-between">
              ...
              <Popover
                ...
                content={
                  <div className="shadow-none bg-[#161616] border border-[#1F1F1F] rounded-[6px] width-296">
                    <div className="p-[1.45rem] pb-[1.4rem] pt-[1.2rem] flex items-start justify-start flex-col border-b-[1px] border-b-[#1F1F1F]">
                      ...
                      <Text_12_400_757575 className="leading-[1.07rem] mt-[.38rem]">
                        Apply the following filters to find worker of your
                        choice.
                      </Text_12_400_757575>
                    </div>
