  ...
  const columns = [
    ...
    },
    {
      ...
      render: (type: BlockingRuleType) => (
        <span className="text-[#EEEEEE]">{RULE_TYPE_LABELS[type] || type}</span>
      ),
    },
    {
      title: "Priority",
    ...
    },
    {
      ...
      key: "match_count",
      sorter: (a: any, b: any) => (a.match_count || 0) - (b.match_count || 0),
      render: (count: number) => (
        <span className="text-[#EEEEEE]">{count || 0}</span>
      ),
    },
    {
      title: "Created",
