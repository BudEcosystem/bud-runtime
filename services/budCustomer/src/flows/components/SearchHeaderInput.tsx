...
export default function SearchHeaderInput({
  ...
  const searchIcon = (
    <svg
      ...
      viewBox="0 0 14 15"
      fill="none"
      className="transition-colors duration-200 text-[var(--text-muted)] group-hover:text-[var(--text-primary)]"
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  return (
    <Input
      ref={inputRef}
      className={`group custom-ant-input outline-none bg-transparent text-[var(--text-primary)] rounded-[6px] pl-[.75rem] py-[0.2625rem] text-[.75rem] font-[400] !placeholder:text-[var(--text-muted)] cursor-pointer ${classNames}`}
      ...
      style={{
        ...
        borderColor: isExpanded ? "var(--border-secondary)" : "transparent",
