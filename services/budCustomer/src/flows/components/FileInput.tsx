      ...
      <div className={`floating-textarea`}>
        <FloatLabel
          label={
            <InfoLabel
              text={props.label}
              content={props.infoText || "Upload a file"}
            ...
            {fileList.length === 0 ? (
              ...
              <p className="ant-upload-text">
                {fileList.map((file) => (
                  <div
                    key={file.uid}
                    className="flex items-center gap-[.5rem] justify-center"
                  >
                    <svg
                      width="0.875rem"
                      height="0.875rem"
