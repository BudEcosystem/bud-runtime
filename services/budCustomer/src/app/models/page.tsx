...
const mockModels: Model[] = [
  {
    ...
    author: "OpenAI",
    description:
      "Most capable GPT-4 model, great for tasks that require creativity and advanced reasoning.",
  ...
  },
  {
    ...
    author: "Anthropic",
    description:
      "Claude 3.5 Sonnet delivers better-than-Opus capabilities, faster-than-Sonnet speeds.",
    provider_type: "cloud_model",
    model_size: 200,
  ...
  },
  {
    ...
    author: "Meta",
    description:
      "Large language model trained on a diverse dataset for general-purpose text generation.",
    provider_type: "model",
    model_size: 70,
  ...
  },
  {
    ...
    author: "OpenAI",
    description:
      "Most advanced image generation model with exceptional quality and prompt adherence.",
    provider_type: "cloud_model",
    model_size: 50,
    icon: "/icons/openAi.png",
    status: "Available",
  ...
  },
  {
    ...
    author: "OpenAI",
    description:
      "State-of-the-art speech recognition model supporting 99+ languages.",
    provider_type: "model",
    model_size: 1.5,
    icon: "/icons/openAi.png",
    status: "Available",
  ...
  },
  {
    ...
    author: "Stability AI",
    description:
      "Advanced text-to-image model with high-resolution output and artistic capabilities.",
    provider_type: "model",
    model_size: 3.5,
    icon: "/icons/huggingFace.png",
    status: "Available",
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <Text_12_400_757575>
                      {dayjs(model.updated_at).format("DD MMM, YYYY")}
                    </Text_12_400_757575>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    ...
                    <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-bud-bg-tertiary text-bud-text-muted">
                      ...
                      <Text_12_400_B3B3B3>
                        {model.name.replace(/[^a-zA-Z0-9]/g, "").toLowerCase()}
                      </Text_12_400_B3B3B3>
                    </div>
                  </div>
