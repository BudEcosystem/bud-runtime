...
name, version = get_project_name_and_version("budcluster/__about__.py")
...
setup(
    ...
    version=version,
    description=(
        "Bud-Serve-Cluster is a microservice within the bud-microframe ecosystem."
        "It provides essential routes for onboarding and monitoring clusters."
    ),
    long_description=read_file("README.md"),
    long_description_content_type="text/markdown",
    url="https://github.com/BudEcosystem/bud-serve-cluster",
    project_urls={
        "Homepage": "https://github.com/BudEcosystem/bud-serve-cluster",
        "Documentation": "https://github.com/BudEcosystem/bud-serve-cluster/blob/main/README.md",
        "Issues": "https://github.com/BudEcosystem/bud-serve-cluster/issues",
        "Changelog": "https://github.com/BudEcosystem/bud-serve-cluster/blob/main/CHANGELOG.md",
    },
