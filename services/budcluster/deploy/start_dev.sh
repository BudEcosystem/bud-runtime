...
echo "🌍 Dapr Placement Host  : $DAPR_PLACEMENT_HOST"
echo "🌍 Dapr Placement Port  : $DAPR_PLACEMENT_PORT"
echo "🌍 Dapr Scheduler Host : $DAPR_SCHEDULER_HOST"
echo "🌍 Dapr Scheduler Port : $DAPR_SCHEDULER_PORT"
