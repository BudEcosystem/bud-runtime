...
# Create additional IAM policy for Cluster Autoscaler if enabled
...
# Attach Cluster Autoscaler policy if enabled
...
# Create a CloudWatch log group for EKS cluster logs
