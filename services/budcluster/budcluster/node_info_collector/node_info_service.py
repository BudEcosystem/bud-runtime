...
async def get_node_info_python(kubeconfig_dict: Dict[str, Any], platform: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        raise Exception(f"Failed to query Kubernetes API: {e}")
    except Exception as e:
