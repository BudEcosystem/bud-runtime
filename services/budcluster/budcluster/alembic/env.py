...
from budmicroframe.shared.dapr_workflow import WorkflowRunsSchema, WorkflowStepsSchema  # noqa: F401

# from budcluster.commons.database import Base
from budmicroframe.shared.psql_service import PSQLBase
from pydantic import PostgresDsn
from sqlalchemy import create_engine, engine_from_config, pool
from sqlalchemy_utils import create_database, database_exists

from budcluster.benchmark_ops.models import BenchmarkResultSchema, BenchmarkSchema  # noqa: F401
from budcluster.cluster_ops.models import Cluster, ClusterNodeInfo  # noqa: F401
from budcluster.deployment.models import WorkerInfo  # noqa: F401
...
def get_psql_url() -> PostgresDsn:
    """Get the psql url."""
    if (
        os.getenv("PSQL_HOST") is None
        or os.getenv("PSQL_PORT") is None
        or os.getenv("PSQL_DB_NAME", "budcluster") is None
    ):
