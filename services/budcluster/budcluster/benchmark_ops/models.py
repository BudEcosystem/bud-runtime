...
class BenchmarkResultSchema(PSQLBase, TimestampMixin):
    ...
    p25_throughput: Mapped[float] = mapped_column(Float, nullable=True)
    p75_throughput: Mapped[float] = mapped_column(Float, nullable=True)
    p95_throughput: Mapped[float] = mapped_column(Float, nullable=True)
    p99_throughput: Mapped[float] = mapped_column(Float, nullable=True)
    min_throughput: Mapped[float] = mapped_column(Float, nullable=True)
    max_throughput: Mapped[float] = mapped_column(Float, nullable=True)
