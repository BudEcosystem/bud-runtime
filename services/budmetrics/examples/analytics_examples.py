        ...
        async with session.post(ANALYTICS_ENDPOINT, json=payload) as response:
            ...
            if result.get("items"):
                for period in result["items"]:
                    print(f"  {period['time_period']} - Requests: {period['items'][0]['data']['request_count']['count']:,}")
...
async def example_4_filtered_metrics():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(ANALYTICS_ENDPOINT, json=payload) as response:
            ...
            print(f"Request: Hourly metrics for specific project")
...
async def example_5_performance_metrics():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(ANALYTICS_ENDPOINT, json=payload) as response:
            ...
            print(f"Request: Hourly performance metrics by endpoint")
...
async def example_6_cache_metrics():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(ANALYTICS_ENDPOINT, json=payload) as response:
            ...
            print(f"Request: Daily cache metrics by model")
...
async def example_7_token_metrics():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(ANALYTICS_ENDPOINT, json=payload) as response:
            ...
            print(f"Request: Daily token usage by project and model")
...
async def example_8_error_analysis():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(ANALYTICS_ENDPOINT, json=payload) as response:
            ...
            print(f"Request: 6-hourly error rates by endpoint")
