...
name, version = get_project_name_and_version("budprompt/__about__.py")
...
setup(
    ...
    version=version,
    description=(
        "BudPrompt is a cloud service that provides compatibility checking and update synchronization for Bud inference runtimes on customer infrastructure. It acts as a central registry for validated models and engine versions."
    ),
    long_description=read_file("README.md"),
    long_description_content_type="text/markdown",
    url="https://github.com/BudEcosystem/bud-serve-prompt",
    project_urls={
        "Homepage": "https://github.com/BudEcosystem/bud-serve-prompt",
        "Documentation": "https://github.com/BudEcosystem/bud-serve-prompt/blob/main/README.md",
        "Issues": "https://github.com/BudEcosystem/bud-serve-prompt/issues",
        "Changelog": "https://github.com/BudEcosystem/bud-serve-prompt/blob/main/CHANGELOG.md",
    },
    ...
    package_data={"budprompt": ["py.typed"]},
