...
class VolumeInitializer:
    ...
    async def ensure_eval_datasets_volume(self, kubeconfig: Optional[str] = None):
        ...
        pvc_name = os.environ.get("EVAL_DATASETS_PATH", "bud-dev-budeval-dataset")
    ...
    #                     "--image=busybox",
    #                     "--overrides",
    #                     '{"spec":{"containers":[{"name":"dataset-verify","volumeMounts":[{"name":"data","mountPath":"/data"}]}],"volumes":[{"name":"data","persistentVolumeClaim":{"claimName":"bud-dev-budeval-dataset"}}]}}',
    #                     "--",
    #                     "sh",
    #                     "-c",
