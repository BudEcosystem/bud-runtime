  ...
  return (
    <div className="px-[1.4rem] py-[1.8rem] rounded-es-lg rounded-ee-lg pb-[.5rem]">
      <div className="flex items-center justify-between gap-[0.625rem]">
        ...
        {buttonLabel && (
          <PrimaryButton
            classNames="!min-w-[107px] !px-[1.5rem]"
        ...
        {filterClick && (
          <div onClick={filterClick} className="cursor-pointer">
            <svg
              width="1rem"
              height="1rem"
              viewBox="0 0 14 15"
