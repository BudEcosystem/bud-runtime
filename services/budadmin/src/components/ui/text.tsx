...
const Text_40_400_EEEEEE = ({ children, className = "", ...props }) => (
  <Text
    as="div"
    className={`block text-[2.5rem] font-[400] text-[#EEEEEE] ${className}`}
    {...props}
  >
    {children}
  </Text>
);
const Text_14_400_abb2bf = ({ children, className = "", ...props }) => (
  <Text
    as="div"
    className={`block text-[0.875rem] font-[400] text-[#abb2bf] ${className}`}
    {...props}
  >
    {children}
  </Text>
...
const Text_15_600_EEEEEE = ({ children, className = "", ...props }) => (
  <Text
    as="div"
    className={`block text-[0.9375rem] font-[600] text-[#EEEEEE] ${className}`}
    style={{
      lineHeight: '100%'
    }}
    {...props}
...
const Text_18_600_EEEEEE = ({ children, className = "", ...props }) => (
  <Text
    as="div"
    className={`block text-[1.125rem] font-[600] text-[#EEEEEE] ${className}`}
    {...props}
  >
    {children}
  </Text>
...
const Text_18_600_FFFFFF = ({ children, className = "", ...props }) => (
  <Text
    as="div"
