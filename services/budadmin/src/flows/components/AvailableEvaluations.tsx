      ...
      <div className="flex justify-between items-start w-full">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              <Text_14_400_EEEEEE className="truncate overflow-hidden whitespace-nowrap leading-[150%]">
                {data.name}
              </Text_14_400_EEEEEE>
            </div>
        ...
        <div className="flex justify-end items-center w-[1rem] ">
          {(hover || selected) && !hideSelection && (
            <Checkbox
              checked={selected}
              className="AntCheckbox text-[#757575] w-[0.875rem] h-[0.875rem] text-[0.875rem] mt-[.5rem]"
            />
          )}
        </div>
      </div>
