...
export default function GuardrailHardwareMode() {
  ...
  return (
    <BudForm
      data={{}}
      disableNext={!selectedMode || workflowLoading}
      onNext={handleNext}
      onBack={handleBack}
      backText="Back"
      nextText="Next"
      ...
      <BudWraperBox>
        <BudDrawerLayout>
          <DrawerTitleCard
            ...
            description="Choose how your guardrail models will use compute resources. This affects performance, cost, and resource sharing."
          />
          ...
          <div className="pt-[.6rem]">
            <HardwareModeCard
              ...
              description="Exclusive GPU/CPU allocation for your guardrail models. Guarantees consistent performance with zero resource contention."
              ...
              benefits={[
                ...
                "Ideal for production guardrails",
