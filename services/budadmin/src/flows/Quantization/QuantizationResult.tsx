  ...
  return (
    <div className="w-[50%] flex items-center justify-start mb-[0.2rem]">
      ...
      <div className="w-[55px] flex flex-shrink-0 justify-start items-center">
        <div
          className={`text-align-center font-[400] text-[0.625rem] px-[.2rem] py-[.15rem] px-[.8rem] rounded-[6px] bg-[#D1B85433] text-[#D1B854]`}
        >
          {value}
        </div>
      </div>
...
export default function QuantizationResult() {
  ...
  const handleNext = () => {
    setSelectedModel(
      currentWorkflow?.workflow_steps?.quantization_config?.quantized_model,
    );
