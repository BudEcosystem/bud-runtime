...
export default function StimulateRun() {
  const { openDrawerWithStep, openDrawer, setPreviousStep, currentFlow, step } =
    useDrawer();
  const { currentWorkflow, setRunAsSimulation, runAsSimulation, stepEight } =
...
hardware configuration. We have usually noticed less than 8% accuracy difference between an actual benchmark, but with almost zero cost."
          ...
          <div className="px-[1.4rem] mt-[.9rem] mb-[1.55rem]">
            <div>
              <Text_14_400_EEEEEE>
                A Good Rule of thumb that we recommend:
              </Text_14_400_EEEEEE>
            </div>
            <div className="pt-[1.05rem] flex flex-col gap-y-[.6rem]">
              <div className="flex items-baseline justify-start gap-x-[.7rem]">
                ...
                <div className="w-[95%]">
                  <Text_12_400_EEEEEE>
                    For production deployments, always simulate & do actual
                    benchmarking on the hardware.
                  </Text_12_400_EEEEEE>
                </div>
              </div>
              <div className="flex items-center justify-start gap-x-[.7rem]">
                ...
                <div>
                  <Text_12_400_EEEEEE>
                    For test, staging or dev clusters, mostly simulation will
                    suffice.
                  </Text_12_400_EEEEEE>
                </div>
              </div>
