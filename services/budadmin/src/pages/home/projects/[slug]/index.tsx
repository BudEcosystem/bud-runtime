...
import InferenceListView from "./inferences";
...
const ProjectDetailsPage = () => {
  ...
  const {
    getGlobalProject,
    globalSelectedProject: selectedProjectResult,
    deleteProject,
    setProjectValues,
    projectMembers,
    selectedProjectId,
              ...
              },
              {
                label: (
                  <div className="flex items-center gap-[0.375rem]">
                    ...
                    {activeTab === "2" ? (
                      <Text_14_600_EEEEEE>Routes</Text_14_600_EEEEEE>
                    ) : (
              ...
              },
              {
                label: (
                  <div className="flex items-center gap-[0.375rem]">
                    ...
                    >
                      <path
                        d="M9.73948 3.16941L9.73942 3.16938L9.738 3.17294C9.65338 3.38531 9.73436 3.63325 9.94285 3.72571L9.98339 3.63429L9.94189 3.72527C11.8405 4.59133 13.0573 6.50744 13.0573 8.59044C13.0573 8.761 13.0572 8.92568 13.0406 9.08954C13.0179 9.31314 13.1926 9.53291 13.4184 9.55585L13.4183 9.55636H13.4285H13.4623C13.6817 9.55636 13.8623 9.40044 13.8841 9.17765L13.8841 9.17711C13.9013 8.99031 13.9183 8.79979 13.9184 8.5911L13.9183 8.59043C13.9022 6.19269 12.4879 3.9849 10.2975 2.96675L10.2597 2.9492L10.2542 2.95125C10.051 2.88999 9.82646 2.97328 9.73948 3.16941Z"
                        fill="#B3B3B3"
                        stroke="#B3B3B3"
                        strokeWidth="0.2"
                      />
                      <path
                        d="M2.38044 8.58519C2.38044 6.50355 3.5958 4.60476 5.49417 3.72082C5.71675 3.63023 5.80581 3.36454 5.69733 3.16176C5.60522 2.94077 5.33967 2.8532 5.1376 2.96279C2.94927 3.96399 1.53685 6.18615 1.53532 8.58199C1.51945 8.78732 1.51912 8.98135 1.55415 9.17686C1.57848 9.39684 1.7571 9.55112 1.97544 9.55112H2.00925V9.55163L2.01936 9.5506C2.24258 9.52793 2.41962 9.32793 2.39726 9.08523L2.39726 9.08523L2.39717 9.0843C2.38052 8.92043 2.38044 8.75576 2.38044 8.58519Z"
                        fill="#B3B3B3"
                        stroke="#B3B3B3"
                        strokeWidth="0.2"
                      />
                      <path
                        d="M4.59667 12.9666L4.59665 12.9667C5.51303 13.6162 6.57948 13.9494 7.69619 13.9494C8.81348 13.9494 9.89546 13.6163 10.7936 12.9682C10.9899 12.816 11.2574 12.8587 11.3927 13.0572C11.5443 13.2541 11.5005 13.5219 11.3007 13.6565C11.3004 13.6567 11.3001 13.6569 11.2997 13.6571L11.2441 13.574C10.2084 14.304 8.98647 14.6946 7.71345 14.6946C6.44043 14.6946 5.21846 14.304 4.1828 13.574L4.59667 12.9666ZM4.59667 12.9666L4.59446 12.9652C4.39637 12.8325 4.15413 12.8805 4.0055 13.0499L3.99538 13.0615L3.98919 13.0755C3.90659 13.2625 3.94251 13.5195 4.12296 13.6542L4.14957 13.674H4.15124L4.59667 12.9666Z"
                        fill="#B3B3B3"
                        stroke="#B3B3B3"
                        strokeWidth="0.2"
                      />
                      <path
                        d="M5.89609 2.8318C5.89609 3.83782 6.70468 4.64642 7.71071 4.64642C8.71674 4.64642 9.52532 3.83783 9.52532 2.8318C9.52532 1.82578 8.71674 1.01719 7.71071 1.01719C6.70468 1.01719 5.89609 1.82577 5.89609 2.8318ZM8.68004 2.8318C8.68004 3.37065 8.24943 3.80127 7.71058 3.80127C7.17173 3.80127 6.74112 3.37065 6.74112 2.8318C6.74112 2.29296 7.17173 1.86234 7.71058 1.86234C8.24943 1.86234 8.68004 2.29296 8.68004 2.8318Z"
                        fill="#B3B3B3"
                        stroke="#B3B3B3"
                        strokeWidth="0.2"
                      />
                      <path
                        d="M0.961249 11.0225L0.961248 11.0225C0.835426 11.4906 0.907445 11.9757 1.14051 12.3879C1.37468 12.8021 1.77017 13.1074 2.23726 13.2329L2.23723 13.233L2.24157 13.234C2.4 13.2691 2.54325 13.2874 2.7048 13.2874C3.01146 13.2874 3.33462 13.1975 3.60436 13.0361C4.46551 12.5334 4.77147 11.4206 4.26775 10.5571C3.76513 9.69562 2.65209 9.38944 1.78848 9.89326L1.78837 9.89306L1.7827 9.89691C1.39128 10.1627 1.08687 10.5551 0.961249 11.0225ZM2.46054 12.4298L2.46057 12.4297L2.45646 12.4287C2.21279 12.368 1.9979 12.1996 1.87478 11.9855C1.75169 11.7523 1.72125 11.4897 1.78279 11.2423L1.78465 11.2349C1.84694 10.9938 2.01468 10.7817 2.22717 10.66C2.68835 10.3989 3.27306 10.5517 3.5513 11.014C3.81171 11.4751 3.65866 12.0593 3.19658 12.3373C2.98034 12.4609 2.71962 12.506 2.46054 12.4298Z"
                        fill="#B3B3B3"
                        stroke="#B3B3B3"
                        strokeWidth="0.2"
                      />
                      <path
                        d="M11.1196 10.6046C10.6401 11.4389 10.9309 12.5132 11.7595 13.0255L11.7598 13.0274L11.8019 13.051C12.0861 13.2104 12.3912 13.3011 12.6995 13.3011C12.859 13.3011 13.0204 13.2831 13.1652 13.2471L13.1652 13.2471L13.167 13.2466C13.6341 13.1211 14.0296 12.8159 14.2637 12.4016C14.4968 11.9894 14.5688 11.5044 14.443 11.0362C14.3175 10.5693 14.0125 10.174 13.5986 9.9398C12.7351 9.43646 11.6224 9.74268 11.1199 10.604L11.1199 10.604L11.1196 10.6046ZM12.2058 12.3334C11.7616 12.0555 11.6098 11.4547 11.8692 11.0117C12.0543 10.7033 12.378 10.5343 12.6995 10.5343C12.8666 10.5343 13.0206 10.5795 13.18 10.659C13.4066 10.7805 13.5595 10.9928 13.6208 11.2395C13.6825 11.4874 13.6518 11.7504 13.5275 11.9831C13.4062 12.2104 13.1936 12.3636 12.9465 12.4251C12.6996 12.4865 12.4377 12.4563 12.2058 12.3334Z"
                        fill="#B3B3B3"
                        stroke="#B3B3B3"
                        strokeWidth="0.2"
                      />
                    ...
                    {activeTab === "4" ? (
                      <Text_14_600_EEEEEE>Clusters</Text_14_600_EEEEEE>
                    ) : (
                  ...
                  <div className="flex items-center gap-[0.375rem]">
                    <div className="flex items-baseline justify-center ">
                      <Image
                        ...
                        src="/icons/guardWhite.png"
                        alt="Logo"
                      />
                    </div>
                    {activeTab === "5" ? (
                      <Text_14_600_EEEEEE>Guardrails</Text_14_600_EEEEEE>
                    ) : (
                      <Text_14_600_B3B3B3>Guardrails</Text_14_600_B3B3B3>
                    )}
                  </div>
                ),
                key: "6",
      ...
      <div className="boardPageView">
        ...
        <div className="projectDetailsDiv">
          <Tabs
            ...
            items={projectTabs.filter((tab) => !tab.hide)}
          />
        </div>
      </div>
    </DashBoardLayout>
