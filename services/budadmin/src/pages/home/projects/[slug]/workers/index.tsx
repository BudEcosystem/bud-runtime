...
const columns: ColumnsType<IWorker> = [
  ...
  },
  {
    ...
    dataIndex: "status",
    key: "status",
    render: (text) => <Tags name={text} color="#D1B854" />,
  ...
  },
  {
    ...
    render: (text) => (
      <Text_12_400_EEEEEE className="whitespace-nowrap">
        {formatTimeToHMS(text)}
      </Text_12_400_EEEEEE>
    ),
    sorter: (a, b) =>
      new Date(a.uptime).getTime() - new Date(b.uptime).getTime(),
    sortIcon: SortIcon,
  },
  {
    ...
    sorter: (a, b) =>
      new Date(a.last_restart_datetime).getTime() -
      new Date(b.last_restart_datetime).getTime(),
    sortIcon: SortIcon,
  },
  {
    ...
    sorter: (a, b) =>
      new Date(a.last_updated_datetime).getTime() -
      new Date(b.last_updated_datetime).getTime(),
    sortIcon: SortIcon,
  },
  {
    title: "Node IP",
  ...
  return (
    <div className="relative">
      <Table<IWorker>
        ...
        locale={{
          emptyText: (
            <NoDataFount classNames="h-[20vh]" textMessage={`No workers`} />
          ),
        }}
      />
    </div>
