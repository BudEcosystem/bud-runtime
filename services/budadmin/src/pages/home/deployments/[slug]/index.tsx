...
import { Text_14_600_FFFFFF, Text_26_600_FFFFFF } from "@/components/ui/text";
...
const ProjectDetailsPage = () => {
  ...
  const deploymentTabs = [
      ...
      label: (
        <div className="flex items-center gap-2">
          ...
          <Text_14_600_FFFFFF
            ...
            style={{
              color: activeTab === "1" ? "#EEEEEE" : "#B3B3B3",
            }}
          >
            General
          </Text_14_600_FFFFFF>
    ...
    // Hide Adapters tab if engine doesn't support LoRA
    ...(clusterDetails?.deployment_config?.engine_configs?.supports_lora !== true
      ? []
      : [
          {
            label: (
              <div className="flex items-center gap-2">
                ...
                <Text_14_600_FFFFFF
                  className="hover:text-[#EEEEEE]"
                  style={{
                    color: activeTab === "2" ? "#EEEEEE" : "#B3B3B3",
                  }}
                >
                  Adapters
                </Text_14_600_FFFFFF>
      ...
      label: (
        <div className="flex items-center gap-2">
          ...
          <Text_14_600_FFFFFF
            className="hover:text-[#EEEEEE]"
            style={{
              color: activeTab === "6" ? "#EEEEEE" : "#B3B3B3",
            }}
          >
            Model Evaluations
          </Text_14_600_FFFFFF>
      ...
      <div className="boardPageView">
        ...
        <div className="projectDetailsDiv pb-3">
          <Tabs
            ...
            items={deploymentTabs.filter((tab) => !tab.hide)}
          />
        </div>
      </div>
    </DashBoardLayout>
