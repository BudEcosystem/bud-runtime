...
function ChartCard({
  ...
  return (
    <div
      className={`bg-[#101010] p-[1.55rem] py-[2rem] rounded-[6.403px] border-[1.067px] border-[#1F1F1F] w-full h-[${height}] flex items-center justify-between flex-col`}
    >
                  ...
                  <List.Item className="border-[#212225] py-2">
                    <div className="w-full">
                      <div className="flex justify-between mb-1">
                        <Text_12_400_EEEEEE className="truncate max-w-[60%]">
                          {item.model}
                        </Text_12_400_EEEEEE>
                        <Text_12_400_B3B3B3>
