...
Placement choices and workflow status tracking make it clear when a model is ready for downstream consumption.
...
- Mandatory signing/attestation for local artifacts  for supply-chain visibility.
