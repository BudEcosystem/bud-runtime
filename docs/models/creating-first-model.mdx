...
<Check>Your model is successfully onboarded and visible in the repository.</Check>
<Check>Verification signals are available for governance review.</Check>
<Check>The model is ready for deployment and project workflows.</Check>
...
<CardGroup cols={2}>
  ...
  <Card title="Security and verification" icon="shield" href="/models/guides/model-security-and-verification">
    Apply trust controls before production usage.
  </Card>
  <Card title="Benchmarking guide" icon="gauge" href="/models/guides/benchmarking-and-evaluations">
