...
3. Use the delta chips to judge cost/efficiency trends, especially for local deployments vs cloud endpoints.

### 4.7 Compare model accuracy

1. Open Accuracy and confirm “For the top 5 models” caption.
2. Review benchmark bars (MMLU, ARC-C, GSM8K, Math, HumanEval) per model.
...
1. Scan Endpoints, Clusters, and Projects cards for totals and other details.
