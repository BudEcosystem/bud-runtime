...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `image` | file | Yes | Original image (PNG, <4MB, square) |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `image` | file | Yes | Source image (PNG, <4MB, square) |
| `model` | string | Yes | Model identifier (e.g., `dall-e-2`) |
...
<CardGroup cols={2}>
  ...
  <Card title="Fireworks">
    ⚠️ Limited support - Returns errors due to async API incompatibility.
  </Card>
  <Card title="Dummy">
    Test provider for development and testing image generation workflows.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Dummy">
    Test provider for development and testing image editing features.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Dummy">
    Test provider for development and testing image variation generation.
  </Card>
</CardGroup>