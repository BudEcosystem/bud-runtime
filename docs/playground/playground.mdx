...
**Q2. What models can I try in the Playground?**
...
**Q3. Which experiments does Playground support?**
...
**Q4. Can I tune model parameters while testing?**

Yes. Temperature, top-k, and top-p controls are available so you can adjust generation settings between runs.

**Q5. How are conversations stored?**

Saved conversations record creator, timestamp, model/route, and tags. They remain in the project scope until deleted or archived, preserving auditability for compliance.

**Q6. Can I copy or rerun specific messages?**
...
**Q7. Does Playground support observability?**

Yes. Latency, token counts, and backend identifiers appear alongside responses. Deep links to Observability tab help correlate Playground runs with full inference traces.

**Q8. How do I capture results for stakeholders?**
