...
The tab appears in the primary navigation alongside Projects, Models, and Clusters, giving one-click access to a secure session. It provides real-time inference, model comparison, and streaming output etc to keep experimentation fast and repeatable across supported providers.
