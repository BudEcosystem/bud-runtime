...
![Pipeline List](/images/pipelines/pipeline-list.svg)
...
![Pipeline Editor](/images/pipelines/pipeline-editor-flow.svg)
...
![Pipeline Runs](/images/pipelines/runs-table.svg)
