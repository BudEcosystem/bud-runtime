...
5. Structured and unstructured inputs/outputs are supported: add input and output variables (string, number, boolean, array, object) or keep the prompt freeform.
