...
2. Update the existing details such as name, default version number, tags and description.
...
1. Open a project detail page and select the Agents tab.
1. Click an agent row to open its detail page.
...
1. Open a project detail page and select the Agents tab.
1. Click an agent row to open its detail page.
1. Click Edit on the desired version card.
2. Preloads existing version metadata and its linked deployment.
3. Update prompts or deployment references and save to keep the version synchronized.
4. Default version can be modified from the Project Agents tab as well. Hover over the preferred agent and click the Edit icon.
