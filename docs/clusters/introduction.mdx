...
description: "Register, operate, and govern clusters for Bud workloads"
---
...
**Hardware-aware planning** Understand CPU/GPU/HPU availability, worker utilization, and scaling readiness.
