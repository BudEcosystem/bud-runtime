...
Open deployment detail page and select Settings tab
...
Open deployment detail page and select Benchmarks tab
...
Search and filters (status, model name, cluster name, TPOT, TTFT) are available to focus on specific benchmark results.

Click Run Another Benchmark to initiate a new benchmark run.

#### 4.7.5 Model Evaluations

Open deployment detail page and select Model Evaluations tab
...
Navigate to **Nodes** to see pool membership, operating system, and GPU/CPU type badges.
