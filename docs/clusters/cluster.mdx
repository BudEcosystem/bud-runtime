...
Switch the time filter (Today, 7 Days, This Month) to refresh utilization charts. Inspect CPU/GPU/HPU, memory, storage, and network bandwidth gauges to spot capacity or performance issues.
