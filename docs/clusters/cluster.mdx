...
3. View the cluster listing page with counts of deployments, hardware type, and available nodes count etc
...
5. Refer to the [[Observability guide](https://budecosystem-b7b14df4.mintlify.app/observability/observability)] for deeper analytics and diagnostics coverage across clusters.
