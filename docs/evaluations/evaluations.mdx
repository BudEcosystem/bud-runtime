...
3. Click on Evaluations Hub tab.
3. View dataset catalog with modality, trait tags; deep links to GitHub, papers, and websites etc.
1. In the catalog header, type keywords (e.g., “finance”, “reasoning”) into the search bar.
2. Toggle trait pills to include or exclude skills or domains. The dataset count updates immediately.

### 4.3 Evaluation details

3. Click a dataset to open detail page.
1. On the detail page, view the description and tags. 
