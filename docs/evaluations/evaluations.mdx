...
### 3. Filter-first navigation with instant search

Search by name or description and toggle trait pills to narrow the catalog; counts reflect the filtered set in real time so reviewers know coverage before opening a card.

### 4. Rich evaluation detail workspace
...
### 5. Governance and exportability

Experiments, runs, and workflows respect Bud RBAC; CSV export buttons on project evaluation lists support audits and downstream reporting.

### Tabbed evaluation workspace
