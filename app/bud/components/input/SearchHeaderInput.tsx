...
export default function SearchHeaderInput({
  ...
  return (
    <Input
      ref={inputRef}
      className={`custom-ant-input outline-none bg-transparent text-[#EEEEEE] rounded-[6px] pl-[.75rem] py-[0.2625rem] text-[.75rem] font-[400] !placeholder:text-[#757575] ${classNames}`}
