...
function Editor(props) {
    return (React.createElement("div", { className: "flex flex-row w-full justify-center items-center mb-[.5rem] bg-[#101010]" },
        React.createElement("form", { className: "chat-message-form   w-full  flex items-center justify-center  border-t-2 rounded-[0.625rem] relative z-10" },
            React.createElement("div", { className: "blur-[0.5rem] absolute top-0 left-0 right-0 bottom-0 bg-[#FFFFFF03] rounded-[0.5rem] " }),
            React.createElement(LexicalComposer_1.LexicalComposer, { initialConfig: editorConfig },
                React.createElement("div", { className: "editor-container" },
                    ...
                    React.createElement(LexicalOnChangePlugin_1.OnChangePlugin, { onChange: function (editorState, editor) {
                            var _a, _b, _c, _d, _e;
                            var data = editorState.toJSON();
                            var children = (_c = (_b = (_a = data === null || data === void 0 ? void 0 : data.root) === null || _a === void 0 ? void 0 : _a.children) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.children;
                            console.log((_d = children[0]) === null || _d === void 0 ? void 0 : _d.text);
                            props.handleInputChange({
                                target: { value: (_e = children[0]) === null || _e === void 0 ? void 0 : _e.text }
                            });
                        } }),
                    React.createElement("div", { className: "editor-inner" },
                        React.createElement(LexicalRichTextPlugin_1.RichTextPlugin, { contentEditable: React.createElement(LexicalContentEditable_1.ContentEditable, { value: props.input, className: "editor-input", name: "editor", "aria-placeholder": placeholder, placeholder: React.createElement("div", { className: "editor-placeholder" }, placeholder) }), ErrorBoundary: LexicalErrorBoundary_1.LexicalErrorBoundary }),
            ...
            React.createElement("button", { className: "z-[999] absolute text-[#EEEEEE30] border-[#757575] border-[1px] rounded-[0.5rem] p-[.5rem] hover:bg-[#1F1F1F4D] hover:text-[#FFF] right-[0.5rem] bottom-[0.5rem] flex items-center gap-[.5rem]", type: "button", onClick: props.handleSubmit },
                "Send",
                React.createElement(antd_1.Image, { src: "icons/send.svg", alt: "send", preview: false })))));
}
